...
function addLiquidityETH() {
  ...
  const txHash =
    "0x6cc4293e9d1ed45e4150ba083607792b59d73b194e03ca9ce8c25dc668b0043b";
  ...
  web3.eth.getTransactionReceipt(txHash, function (error, txResult) {
    ...
    console.log(txResult.logs[3].topics[1]); // to
...
function swapTokenForETH() {
  const decoder = new InputDataDecoder(abi);
  const txHash =
    "0x2909bd098b236f6ea7d9f105ff28dabd2a6c246f35258201c2d933ba3d053c54";
  web3.eth.getTransaction(txHash, (error, txResult) => {
    const result = decoder.decodeData(txResult.input);
  });
  web3.eth.getTransactionReceipt(txHash, function (error, txResult) {
    ...
    // token out
    console.log(txResult.logs[5].address); // token out
    console.log(web3.utils.hexToNumberString(txResult.logs[5].data)); //  amount
  });
}
swapTokenForETH();
