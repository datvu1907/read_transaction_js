...
function buySell() {
  ...
  const txHash =
    "0x77209d769a355d7a5c7c7dfe77de445c735c79e8fd798ad0597c64902e9bfddc";
  ...
  web3.eth.getTransactionReceipt(txHash, function (error, txResult) {
    console.log(txResult);
    const tokenAddress = txResult.logs[0].address;
    const tokenId = txResult.logs[0].data.slice(0, 66);
    const amount = "0x" + txResult.logs[0].data.slice(-64);
    console.log(tokenAddress); // token address
    console.log(web3.utils.hexToNumberString(tokenId));
    console.log(web3.utils.hexToNumberString(amount));
    console.log(txResult.logs[1].topics[1]); // from
    console.log(txResult.logs[1].topics[2]); // to
    const price = "0x" + txResult.logs[1].data.slice(-64);
    console.log(web3.utils.hexToNumberString(price)); // price
  });
}
function cancelOrder() {
  const decoder = new InputDataDecoder(abi);
  const txHash =
    "0xfb4f412e95a6b0ec69d0cd5583db467f82fd094ab568847600fc919890b56447";
  web3.eth.getTransaction(txHash, (error, txResult) => {
    // console.log(txResult);
    // console.log(txResult.value);
    const result = decoder.decodeData(txResult.input);
