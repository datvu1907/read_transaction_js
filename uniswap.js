...
function swap() {
  ...
  const txHash =
    "0xbb7387238f5c641f729080cec50b2c7b725d2c82935d527ad9423e02cb47da67";
  ...
  web3.eth.getTransactionReceipt(txHash, function (error, txResult) {
    console.log(web3.utils.hexToNumberString(txResult.logs[0].data));
    console.log(txResult.logs[0].address);
    console.log(web3.utils.hexToNumberString(txResult.logs[2].data));
...
function withdraw() {
  const decoder = new InputDataDecoder(abi);
  const txHash =
    "0xe1c90d51876dbd41c394c70ca5e76caea5b21c8642c2481cb92c0c97299b0c34";
  web3.eth.getTransaction(txHash, (error, txResult) => {
    const result = decoder.decodeData(txResult.input);
    console.log(result.inputs);
    console.log(
      web3.utils.hexToNumberString(result.inputs[0]) // tokenID
    );
    console.log(result.inputs[1]); // to
    console.log(web3.utils.hexToNumberString(result.inputs[2]));
    console.log(web3.utils.hexToNumberString(result.inputs[3]));
  });
  web3.eth.getTransactionReceipt(txHash, function (error, txResult) {
